view: usagedata {
  sql_table_name: ccbp_qa1.usagedata ;;
  suggestions: no
  ...
  measure: roamingOveargeUsage {
    type: sum
    sql: ${subscriberroamingoverageusage} ;;
  ...
  measure: totalUsage {
    type: sum
    sql: ${subscriberdomesticdataused} + ${subscriberdomesticoverageusage} + ${subscriberroamingoverageusage} + ${subscriberroamingdataused};;
    drill_fields: [masterban_name, subscriberrateplanname, subscriberfirstname, subscriberlastname]
